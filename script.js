...
const FEEDBACK_ITENS = {
  ebooks: {
    ...
    texto: 'O cartão de acesso foi enviado para o seu e-mail. Ao abrir, clique no botão indicado para ser direcionado à plataforma da Hotmart e realizar o download dos seus conteúdos.',
  },
  skiller: {
