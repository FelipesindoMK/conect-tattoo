...
function showUnavailable(btn, msg) {
  ...
  tip.style.cssText = 'display:block;font-size:.74rem;font-weight:700;color:rgba(21,43,85,.55);margin-top:.4rem;text-align:center;';
...
function resetForm() {
  ...
  // Desmarca checkboxes
  ['chk-skiller','chk-ebooks','chk-comunidade','chk-inscricao'].forEach(id => {
