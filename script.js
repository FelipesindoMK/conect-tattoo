...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // O acesso como "member" só é liberado pelo supabase-app.js, depois de uma
  ...
  // e do acesso como "visitante" (que não depende de conta).
  ...
  // sessão falsa (o bug que motivou esse ajuste).
  ...
  window.ConectGate = { enterAsMember, enterAsGuest, logoutAndShowGate, reflectAccessInUI, goToPerfilHub };
